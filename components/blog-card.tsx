...
export default function BlogCard({ post }: BlogCardProps) {
  ...
  return (
    <div className="bg-white shadow-custom-card dark:bg-[#7BBDC5] rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col group h-full">
