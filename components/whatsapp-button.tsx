...
export default function WhatsappButton() {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 wa-btn-enter">
      <style>{`
        .wa-btn-enter {
          animation: waBtnIn 0.5s cubic-bezier(0.34,1.56,0.64,1) both;
          animation-delay: 1s;
        }
        @keyframes waBtnIn {
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              <button className="wa-btn" aria-label="Contactar por WhatsApp">
          ...
          <TooltipContent side="right"><p>Contáctanos por WhatsApp</p></TooltipContent>
        </Tooltip>
      </TooltipProvider>
    </div>
  )
