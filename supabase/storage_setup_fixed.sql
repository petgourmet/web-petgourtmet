...
DROP POLICY IF EXISTS "Imágenes visibles para todos" ON storage.objects;
...
DROP POLICY IF EXISTS "Usuarios autenticados pueden eliminar sus imágenes" ON storage.objects;
...
DROP POLICY IF EXISTS "Usuarios pueden ver sus propios documentos" ON storage.objects;
DROP POLICY IF EXISTS "Usuarios pueden subir sus propios documentos" ON storage.objects;
DROP POLICY IF EXISTS "Usuarios pueden actualizar sus propios documentos" ON storage.objects;
DROP POLICY IF EXISTS "Usuarios pueden eliminar sus propios documentos" ON storage.objects;
DROP POLICY IF EXISTS "Administradores pueden ver todos los documentos" ON storage.objects;
