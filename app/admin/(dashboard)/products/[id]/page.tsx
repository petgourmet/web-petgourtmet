...
export default function ProductForm({ params }: { params: { id: string } }) {
  ...
  const [product, setProduct] = useState<Partial<Product>>({
    ...
    ingredients: "",
    slug: "",
    rating: 4.5, // Valor predeterminado para nuevos productos
    reviews_count: 10, // Valor predeterminado para nuevos productos
  })
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      <div className="flex justify-end">
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setAdditionalImages(
                              newAdditionalImages.length ? newAdditionalImages : [{ src: "", alt: "" }],
                            )
                          }}
                        >
          ...
          <div className="flex justify-end space-x-4">
            ...
            <Button
              type="submit"
              disabled={
                saving || !isAuthenticated || !isAdmin || (multiCategorySupport && selectedCategories.length === 0)
              }
            >
