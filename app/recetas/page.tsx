      ...
      <div className="responsive-section bg-illuminated">
        <div className="responsive-container">
          ...
          <div className="relative w-full h-64 md:h-80 rounded-2xl overflow-hidden mb-16">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-pastel-pink/80 to-transparent flex items-center">
              <div className="p-8 md:p-12 max-w-xl">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-display">Nutrición gourmet</h2>
                <p className="text-white/90 mb-6">Recetas elaboradas por expertos en nutrición canina</p>
                <Button className="bg-white text-primary hover:bg-white/90 rounded-full">Descubrir ingredientes</Button>
              </div>
            </div>
          </div>
