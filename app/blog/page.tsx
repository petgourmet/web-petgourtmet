...
const fallbackBlogPosts = [
  {
    ...
    cover_image: "/natural-dog-food-ingredients.webp",
  ...
  },
  {
    ...
    cover_image: "/happy-labrador-walk.webp",
    published_at: new Date().toISOString(),
    category: { name: "Salud" },
  ...
  },
  {
    ...
    cover_image: "/happy-dog-treat.webp",
    published_at: new Date().toISOString(),
  ...
  },
  {
    ...
    cover_image: "/dog-eating-treat.webp",
    published_at: new Date().toISOString(),
    category: { name: "Guías" },
  ...
  },
  {
    ...
    cover_image: "/woman-and-golden-retriever-park.webp",
    published_at: new Date().toISOString(),
    category: { name: "Nutrición" },
