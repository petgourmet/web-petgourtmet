    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background-color: #f9fafb; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb; margin-top: 20px; border-radius: 0 0 8px 8px;">
            <div style="margin-bottom: 12px;">
              <a href="https://web.facebook.com/petgourmetmx" target="_blank" style="display:inline-block;margin:0 5px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#7AB8BF"/><path fill="white" d="M20.23 19.2h-2.08v7.8H15.3v-7.8H13.8v-2.88h1.5v-1.73c0-2 .93-3.19 3.19-3.19h2.21v2.88H19.4c-.55 0-.73.25-.73.73v1.31h2.07l-.51 2.88z"/></svg></a>
              <a href="https://www.instagram.com/petgourmet_mx/" target="_blank" style="display:inline-block;margin:0 5px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#7AB8BF"/><path fill="white" d="M18 10.8c-1.97 0-2.22.01-3 .04-2.35.11-3.45 1.22-3.56 3.56-.03.77-.04 1.02-.04 2.99s.01 2.22.04 3c.11 2.34 1.21 3.45 3.56 3.56.77.03 1.02.04 3 .04s2.22-.01 3-.04c2.35-.11 3.45-1.22 3.56-3.56.03-.77.04-1.02.04-3s-.01-2.22-.04-3c-.11-2.34-1.21-3.45-3.56-3.56C20.22 10.81 19.97 10.8 18 10.8zm0 1.31c1.93 0 2.16 0 2.92.04 1.78.08 2.6.91 2.69 2.69.03.76.04.98.04 2.92s0 2.16-.04 2.92c-.09 1.77-.91 2.61-2.69 2.69-.76.03-.99.04-2.92.04s-2.16 0-2.92-.04c-1.78-.08-2.6-.92-2.69-2.69-.04-.76-.04-.99-.04-2.92s0-2.16.04-2.92c.09-1.78.91-2.61 2.69-2.69.76-.04.99-.04 2.92-.04zm0 2.23a3.66 3.66 0 100 7.32 3.66 3.66 0 000-7.32zm0 6.03a2.37 2.37 0 110-4.74 2.37 2.37 0 010 4.74zm4.67-6.18a.86.86 0 100 1.72.86.86 0 000-1.72z"/></svg></a>
              <a href="https://www.youtube.com/@PetGourmetMexico" target="_blank" style="display:inline-block;margin:0 5px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#7AB8BF"/><path fill="white" d="M27.4 13.4a2.45 2.45 0 00-1.73-1.73C24 11.2 18 11.2 18 11.2s-6 0-7.67.47a2.45 2.45 0 00-1.73 1.73C8.13 15.07 8.13 18 8.13 18s0 2.93.47 4.6a2.45 2.45 0 001.73 1.73c1.67.47 7.67.47 7.67.47s6 0 7.67-.47a2.45 2.45 0 001.73-1.73C27.87 20.93 27.87 18 27.87 18s0-2.93-.47-4.6zM15.73 20.73V15.27L21.2 18l-5.47 2.73z"/></svg></a>
            </div>
