        ...
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background-color: #f9fafb; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb; margin-top: 20px; border-radius: 0 0 8px 8px;">
            <div style="margin-bottom: 12px;">
              ...
              <a href="https://www.tiktok.com/@petgourmetmex" target="_blank" style="display:inline-block;margin:0 5px;text-decoration:none;vertical-align:middle"><img src="https://petgourmet.mx/iconos/tiktok.png" width="34" height="34" alt="TikTok" style="display:inline-block;border:0;"></a>
