            ...
            <div style="max-width: 600px; margin: 0 auto;">
              ...
              <div style="padding: 30px 20px;">
                ...
                <div style="margin: 28px 0; padding: 20px 24px; background-color: #f0fafe; border-radius: 14px; border: 1px solid #c6e9eb; text-align: center;">
                  ...
                  <a href="https://wa.me/525561269681" target="_blank" style="display: inline-block; background-color: #25D366; color: white; padding: 11px 26px; border-radius: 50px; text-decoration: none; font-weight: 700; font-size: 14px;"><svg width="15" height="15" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" style="display:inline-block;vertical-align:middle;margin-right:6px;margin-bottom:2px"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>Enviar WhatsApp</a>
                </div>
              </div>
              ...
              <div style="background-color: #f9fafb; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb;">
                <div style="margin-bottom: 14px;">
                  <a href="https://web.facebook.com/petgourmetmx" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#1877F2"/><path fill="white" d="M20.23 19.2h-2.08v7.8H15.3v-7.8H13.8v-2.88h1.5v-1.73c0-2 .93-3.19 3.19-3.19h2.21v2.88H19.4c-.55 0-.73.25-.73.73v1.31h2.07l-.51 2.88z"/></svg></a>
                  <a href="https://www.instagram.com/petgourmet_mx/" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="igGA" cx="30%" cy="107%" r="150%"><stop offset="0%" stop-color="#fdf497"/><stop offset="45%" stop-color="#fd5949"/><stop offset="60%" stop-color="#d6249f"/><stop offset="90%" stop-color="#285AEB"/></radialGradient></defs><circle cx="18" cy="18" r="18" fill="url(#igGA)"/><path fill="white" d="M18 10.8c-1.97 0-2.22.01-3 .04-2.35.11-3.45 1.22-3.56 3.56-.03.77-.04 1.02-.04 2.99s.01 2.22.04 3c.11 2.34 1.21 3.45 3.56 3.56.77.03 1.02.04 3 .04s2.22-.01 3-.04c2.35-.11 3.45-1.22 3.56-3.56.03-.77.04-1.02.04-3s-.01-2.22-.04-3c-.11-2.34-1.21-3.45-3.56-3.56C20.22 10.81 19.97 10.8 18 10.8zm0 1.31c1.93 0 2.16 0 2.92.04 1.78.08 2.6.91 2.69 2.69.03.76.04.98.04 2.92s0 2.16-.04 2.92c-.09 1.77-.91 2.61-2.69 2.69-.76.03-.99.04-2.92.04s-2.16 0-2.92-.04c-1.78-.08-2.6-.92-2.69-2.69-.04-.76-.04-.99-.04-2.92s0-2.16.04-2.92c.09-1.78.91-2.61 2.69-2.69.76-.04.99-.04 2.92-.04zm0 2.23a3.66 3.66 0 100 7.32 3.66 3.66 0 000-7.32zm0 6.03a2.37 2.37 0 110-4.74 2.37 2.37 0 010 4.74zm4.67-6.18a.86.86 0 100 1.72.86.86 0 000-1.72z"/></svg></a>
                  <a href="https://www.tiktok.com/@petgourmet_mx" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#010101"/><path fill="#69C9D0" d="M23 15.4a5.43 5.43 0 01-3.35-1.15v5.22a4.84 4.84 0 11-4.15-4.8v2.66a2.2 2.2 0 101.56 2.1V9.95h2.59a3.28 3.28 0 002.83 2.65l.52.09v2.71z"/><path fill="white" d="M22.5 14.9a5.43 5.43 0 01-3.35-1.15v5.22a4.84 4.84 0 11-4.15-4.8v2.66a2.2 2.2 0 101.56 2.1V9.45h2.59a3.28 3.28 0 002.83 2.65v2.8h.52z"/></svg></a>
                </div>
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.5; color: #333; margin: 0; padding: 40px 10px; background-color: #EAECEF;">
        ...
        <div style="max-width: 600px; margin: 0 auto;">
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #E5E7EB; text-align: center;">
            <div style="margin-bottom: 14px;">
              <a href="https://web.facebook.com/petgourmetmx" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#1877F2"/><path fill="white" d="M20.23 19.2h-2.08v7.8H15.3v-7.8H13.8v-2.88h1.5v-1.73c0-2 .93-3.19 3.19-3.19h2.21v2.88H19.4c-.55 0-.73.25-.73.73v1.31h2.07l-.51 2.88z"/></svg></a>
              <a href="https://www.instagram.com/petgourmet_mx/" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="igGB" cx="30%" cy="107%" r="150%"><stop offset="0%" stop-color="#fdf497"/><stop offset="45%" stop-color="#fd5949"/><stop offset="60%" stop-color="#d6249f"/><stop offset="90%" stop-color="#285AEB"/></radialGradient></defs><circle cx="18" cy="18" r="18" fill="url(#igGB)"/><path fill="white" d="M18 10.8c-1.97 0-2.22.01-3 .04-2.35.11-3.45 1.22-3.56 3.56-.03.77-.04 1.02-.04 2.99s.01 2.22.04 3c.11 2.34 1.21 3.45 3.56 3.56.77.03 1.02.04 3 .04s2.22-.01 3-.04c2.35-.11 3.45-1.22 3.56-3.56.03-.77.04-1.02.04-3s-.01-2.22-.04-3c-.11-2.34-1.21-3.45-3.56-3.56C20.22 10.81 19.97 10.8 18 10.8zm0 1.31c1.93 0 2.16 0 2.92.04 1.78.08 2.6.91 2.69 2.69.03.76.04.98.04 2.92s0 2.16-.04 2.92c-.09 1.77-.91 2.61-2.69 2.69-.76.03-.99.04-2.92.04s-2.16 0-2.92-.04c-1.78-.08-2.6-.92-2.69-2.69-.04-.76-.04-.99-.04-2.92s0-2.16.04-2.92c.09-1.78.91-2.61 2.69-2.69.76-.04.99-.04 2.92-.04zm0 2.23a3.66 3.66 0 100 7.32 3.66 3.66 0 000-7.32zm0 6.03a2.37 2.37 0 110-4.74 2.37 2.37 0 010 4.74zm4.67-6.18a.86.86 0 100 1.72.86.86 0 000-1.72z"/></svg></a>
              <a href="https://www.tiktok.com/@petgourmet_mx" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#010101"/><path fill="#69C9D0" d="M23 15.4a5.43 5.43 0 01-3.35-1.15v5.22a4.84 4.84 0 11-4.15-4.8v2.66a2.2 2.2 0 101.56 2.1V9.95h2.59a3.28 3.28 0 002.83 2.65l.52.09v2.71z"/><path fill="white" d="M22.5 14.9a5.43 5.43 0 01-3.35-1.15v5.22a4.84 4.84 0 11-4.15-4.8v2.66a2.2 2.2 0 101.56 2.1V9.45h2.59a3.28 3.28 0 002.83 2.65v2.8h.52z"/></svg></a>
            </div>
            <p style="margin: 0; color: #9CA3AF; font-size: 12px; line-height: 1.5;">
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f9fafb;">
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <div style="background-color: #f9fafb; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb;">
            <div style="margin-bottom: 14px;">
              <a href="https://web.facebook.com/petgourmetmx" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#1877F2"/><path fill="white" d="M20.23 19.2h-2.08v7.8H15.3v-7.8H13.8v-2.88h1.5v-1.73c0-2 .93-3.19 3.19-3.19h2.21v2.88H19.4c-.55 0-.73.25-.73.73v1.31h2.07l-.51 2.88z"/></svg></a>
              <a href="https://www.instagram.com/petgourmet_mx/" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="igGC" cx="30%" cy="107%" r="150%"><stop offset="0%" stop-color="#fdf497"/><stop offset="45%" stop-color="#fd5949"/><stop offset="60%" stop-color="#d6249f"/><stop offset="90%" stop-color="#285AEB"/></radialGradient></defs><circle cx="18" cy="18" r="18" fill="url(#igGC)"/><path fill="white" d="M18 10.8c-1.97 0-2.22.01-3 .04-2.35.11-3.45 1.22-3.56 3.56-.03.77-.04 1.02-.04 2.99s.01 2.22.04 3c.11 2.34 1.21 3.45 3.56 3.56.77.03 1.02.04 3 .04s2.22-.01 3-.04c2.35-.11 3.45-1.22 3.56-3.56.03-.77.04-1.02.04-3s-.01-2.22-.04-3c-.11-2.34-1.21-3.45-3.56-3.56C20.22 10.81 19.97 10.8 18 10.8zm0 1.31c1.93 0 2.16 0 2.92.04 1.78.08 2.6.91 2.69 2.69.03.76.04.98.04 2.92s0 2.16-.04 2.92c-.09 1.77-.91 2.61-2.69 2.69-.76.03-.99.04-2.92.04s-2.16 0-2.92-.04c-1.78-.08-2.6-.92-2.69-2.69-.04-.76-.04-.99-.04-2.92s0-2.16.04-2.92c.09-1.78.91-2.61 2.69-2.69.76-.04.99-.04 2.92-.04zm0 2.23a3.66 3.66 0 100 7.32 3.66 3.66 0 000-7.32zm0 6.03a2.37 2.37 0 110-4.74 2.37 2.37 0 010 4.74zm4.67-6.18a.86.86 0 100 1.72.86.86 0 000-1.72z"/></svg></a>
              <a href="https://www.tiktok.com/@petgourmet_mx" target="_blank" style="display:inline-block;margin:0 4px;text-decoration:none;vertical-align:middle"><svg width="34" height="34" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><circle cx="18" cy="18" r="18" fill="#010101"/><path fill="#69C9D0" d="M23 15.4a5.43 5.43 0 01-3.35-1.15v5.22a4.84 4.84 0 11-4.15-4.8v2.66a2.2 2.2 0 101.56 2.1V9.95h2.59a3.28 3.28 0 002.83 2.65l.52.09v2.71z"/><path fill="white" d="M22.5 14.9a5.43 5.43 0 01-3.35-1.15v5.22a4.84 4.84 0 11-4.15-4.8v2.66a2.2 2.2 0 101.56 2.1V9.45h2.59a3.28 3.28 0 002.83 2.65v2.8h.52z"/></svg></a>
            </div>
            <p style="margin: 0; color: #6b7280; font-size: 12px;">
              © 2025 Pet Gourmet. Todos los derechos reservados.
