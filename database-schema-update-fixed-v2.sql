-- SQL para actualizar las tablas de productos con los campos necesarios (CORREGIDO V2)

-- Primero, modificar la columna image para permitir NULL si existe
...
-- Asegurar que la tabla categories existe (con image nullable)
CREATE TABLE IF NOT EXISTS categories (
    id BIGSERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL UNIQUE,
    slug VARCHAR(255) NOT NULL UNIQUE,
    description TEXT,
    image TEXT, -- Ahora nullable
...
-- Insertar categorías por defecto si no existen (con imágenes por defecto)
INSERT INTO categories (name, slug, description, color, image) VALUES
('Para Premiar', 'para-premiar', 'Productos especiales para premiar a tu mascota', '#10b981', '/para_premiar.png'),
('Para Complementar', 'para-complementar', 'Complementos nutricionales para una dieta balanceada', '#3b82f6', '/para_complementar.png'),
('Para Celebrar', 'para-celebrar', 'Productos especiales para ocasiones especiales', '#f59e0b', '/para_celebrar.png'),
('Nuestras Recetas', 'nuestras-recetas', 'Recetas especiales desarrolladas por nuestros expertos', '#8b5cf6', '/nuestras_recetas.png')
